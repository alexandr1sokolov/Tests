...
import {
  resultIsActive,
  resultIsInactive
} from "../../redux/actions/resultPageActions";
    ...
    <div>
      {props.checkLogin ? (
        <div className={styles.header__container}>
          <div
            className={styles["header__main-nav-link"]}
            onClick={props.resultIsInactiveFunc}
          >
            {props.location.pathname.includes("tests/") && (
              <NavLink
                to="/tests"
          ...
          <ul className={styles["header__menu-nav-links"]}>
            <li className={styles.header__item}>
              <div
                ...
                onClick={props.resultIsActiveFunc}
              >
                Результаты
              </div>
            </li>
        ...
        <div className={styles.header__container2}>
          <div className={styles["header__menu-buttons"]}>
            ...
            <button
              className={
                styles["header__button"] + " " + styles["header__margine-right"]
              }
              onClick={props.showEnter}
            >
              Вход
            </button>
          </div>
